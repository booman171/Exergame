...
import com.mbientlab.metawear.tutorial.exergame.DeviceSetupActivityFragment2.FragmentSettings;

import bolts.Continuation;

import static android.content.DialogInterface.BUTTON_NEGATIVE;

public class DeviceSetupActivity2 extends AppCompatActivity implements ServiceConnection, FragmentSettings {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mbientlab.metawear.tutorial.exergame.R.layout.activity_device_setup2);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            ...
            case com.mbientlab.metawear.tutorial.exergame.R.id.select_activities:
                Intent intent = new Intent(DeviceSetupActivity2.this, SelectActivity.class);
                    ...
                    .continueWith((Continuation<Void, Void>) task -> {
                        if (!task.isCancelled()) {
                            runOnUiThread(() -> {
                                ...
                                ((DeviceSetupActivityFragment2) getSupportFragmentManager().findFragmentById(com.mbientlab.metawear.tutorial.exergame.R.id.device_setup_fragment2)).reconnected();
                            });
                        } else {
                            finish();
                        }
