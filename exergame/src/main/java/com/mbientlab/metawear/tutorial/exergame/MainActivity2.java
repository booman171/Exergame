...
public class MainActivity2 extends AppCompatActivity implements BleScannerFragment.ScannerCommunicationBus, ServiceConnection {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mbientlab.metawear.tutorial.exergame.R.layout.activity_main2);
        ...
        metawear.connectAsync().continueWithTask(task -> task.isCancelled() || !task.isFaulted() ? task : reconnect(metawear))
                .continueWith(task -> {
                    if (!task.isCancelled()) {
                        ...
                        Intent navActivityIntent = new Intent(MainActivity2.this, DeviceSetupActivity2.class);
                        navActivityIntent.putExtra(DeviceSetupActivity2.EXTRA_BT_DEVICE, device);
