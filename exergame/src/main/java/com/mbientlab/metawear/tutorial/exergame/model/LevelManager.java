...
public class LevelManager {
	...
	List<LevelConfig> LEVEL_INFO = Arrays.asList(
		new LevelConfig(5, Arrays.asList(new LevelBulletConfig(60, Bullet.class),
				                         new LevelBulletConfig(2, StopAndGoBullet.class))),

		new LevelConfig(10, Arrays.asList(new LevelBulletConfig(60, Bullet.class),
		...
		new LevelConfig(15, Arrays.asList(new LevelBulletConfig(90, Bullet.class),
								          new LevelBulletConfig(5, StopAndGoBullet.class),
								          new LevelBulletConfig( 5, SineWaveBullet.class))),
